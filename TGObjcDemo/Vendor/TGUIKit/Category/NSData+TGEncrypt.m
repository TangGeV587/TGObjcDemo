...
@implementation NSData (TGEncrypt)
...
- (NSString*)decodeBase64 {
    ...
    const char *characters = [self bytes];
...
//    return [NSData dataWithBytesNoCopy:bytes length:length];
    return [[[NSString alloc] initWithBytesNoCopy:bytes length:length encoding:NSASCIIStringEncoding freeWhenDone:YES] init];
}
...
- (NSString *)md5 {
    ...
    uint8_t digest[CC_MD5_DIGEST_LENGTH], i;
